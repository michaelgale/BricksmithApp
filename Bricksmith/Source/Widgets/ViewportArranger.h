...
@optional -
(void)viewportArranger : (ViewportArranger *)viewportArranger didAddViewport : (LDrawViewerContainer *)
        newViewport sourceViewport : (LDrawViewerContainer *)sourceViewport;
