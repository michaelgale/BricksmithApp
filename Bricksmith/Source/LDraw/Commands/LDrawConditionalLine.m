    ...
    @try
    {
        ...
        if ([parsedField integerValue] == 5) {
            ...
            @throw [NSException exceptionWithName:@"BricksmithParseException" reason:
                   @"Bad conditional line syntax" userInfo:nil];
        }
    }
...
- (void)encodeWithCoder:(NSCoder *)encoder
{
    ...
    [encoder encodeBytes:(void *)&conditionalVertex1 length:sizeof(Point3)
    forKey:@"conditionalVertex1"];
    [encoder encodeBytes:(void *)&conditionalVertex2 length:sizeof(Point3)
