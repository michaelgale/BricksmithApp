...
typedef enum
{
    ScopeFile = 1, ScopeModel     = 2, ScopeStep      = 3, ScopeSelection = 4
} ScopeT;

// How to search for colors
typedef enum
{
    ColorNoFilter = 1, ColorSelectionFilter = 2, ColorFilter          = 3
} ColorFilterT;

// What to search for
typedef enum
{
    SearchAllParts = 1, SearchSpecificPart  = 2, SearchSelectedParts = 3
} SearchPartCriteriaT;
